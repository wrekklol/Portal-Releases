...
## ShapeHelpers.Hypocycloid(double, double, double) Method

内サイクロイドを求めます

```csharp
public static System.Numerics.Vector2 Hypocycloid(double rc, double rm, double theta);
```
#### Parameters

<a name='Portal.Utility.ShapeHelpers.Hypocycloid(double,double,double).rc'></a>

`rc` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

定円の半径

<a name='Portal.Utility.ShapeHelpers.Hypocycloid(double,double,double).rm'></a>

`rm` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

動円の半径

<a name='Portal.Utility.ShapeHelpers.Hypocycloid(double,double,double).theta'></a>

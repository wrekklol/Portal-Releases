...
## ShapeHelpers.Epicycloid(double, double, double) Method

外サイクロイドを求めます

```csharp
public static System.Numerics.Vector2 Epicycloid(double rc, double rm, double theta);
```
#### Parameters

<a name='Portal.Utility.ShapeHelpers.Epicycloid(double,double,double).rc'></a>

`rc` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

定円の半径

<a name='Portal.Utility.ShapeHelpers.Epicycloid(double,double,double).rm'></a>

`rm` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

動円の半径

<a name='Portal.Utility.ShapeHelpers.Epicycloid(double,double,double).theta'></a>

...
## ShapeHelpers.HyperbolicSpiral(double, double) Method

双曲螺旋を求めます

```csharp
public static System.Numerics.Vector2 HyperbolicSpiral(double a, double theta);
```
#### Parameters

<a name='Portal.Utility.ShapeHelpers.HyperbolicSpiral(double,double).a'></a>

`a` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

<a name='Portal.Utility.ShapeHelpers.HyperbolicSpiral(double,double).theta'></a>
